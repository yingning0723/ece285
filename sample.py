...
def parse_arguments():
    ...
    parser.add_argument("--n-samples", type=int, default=400, help="Number of samples to generate")
    parser.add_argument("--n-images-per-row", type=int, default=20, help="Number of images each row contains in the grid")
